...
private final class ThemeSettingsControllerArguments {
    ...
    init(
        ...
        self.openAyuSettings = openAyuSettings
...
private enum ThemeSettingsControllerEntry: ItemListNodeEntry {
    ...
    case powerSaving
    case stickersAndEmoji
    case ayuSettings(PresentationTheme, String)
    ...
    var section: ItemListSectionId {
        ...
        case .themeListHeader, .chatPreview, .themes, .chatTheme, .wallpaper, .nameColor:
            ...
            case .powerSaving, .stickersAndEmoji, .ayuSettings:
                return ThemeSettingsControllerSection.message.rawValue
    ...
    static func ==(lhs: ThemeSettingsControllerEntry, rhs: ThemeSettingsControllerEntry) -> Bool {
        switch lhs {
            ...
            case let .ayuSettings(lhsTheme, lhsTitle):
                if case let .ayuSettings(rhsTheme, rhsTitle) = rhs, lhsTheme === rhsTheme, lhsTitle == rhsTitle {
                    return true
                } else {
                    return false
                }
    ...
    func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        ...
        switch self {
            ...
            case let .ayuSettings(_, title):
                return ItemListDisclosureItem(presentationData: presentationData, systemStyle: .glass, icon: nil, title: title, label: "", labelStyle: .text, sectionId: self.section, style: .blocks, disclosureStyle: .arrow, action: {
                    arguments.openAyuSettings()
                })
...
private func themeSettingsControllerEntries(
    ...
    entries.append(.ayuSettings(presentationData.theme, "Ayu Settings"))
...
public func themeSettingsController(context: AccountContext, focusOnItemTag: ThemeSettingsEntryTag? = nil) -> ViewController {
    ...
    let arguments = ThemeSettingsControllerArguments(context: context, selectTheme: { theme in
        ...
        pushControllerImpl?(ayuSettingsController(context: context))
